    ...
    actions: {
        ...
        createInteractiveMap(): void {
            if (this.mapElementIsReady) {
                ...
                this.markerIsAttachedToMap = true;
            }
        },
        ...
        createStaticMap(): void {
            if (this.mapElementIsReady) {
                ...
                this.markerIsAttachedToMap = false;
            }
        },
            ...
            if (this.map) {
                ...
                if (this.marker) {
                    if (this.marker.isDraggable()) {
                        ...
                        let marker = this.createStaticMarker().setLngLat(
                            this.coordinates
                        );

                        if (this.markerIsAttachedToMap) {
